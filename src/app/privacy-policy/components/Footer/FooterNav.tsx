                ...
                (item, index) => (
                  <div className="flex" key={index}>
                    <NavItem
                      ...
                      text={item}
                      className="font-medium tracking-[-0.04em] leading-[100%] text-[9.5vw] sm:text-[5vw] md:text-[4.7vw] lg:text-[3.3vw] 2xl:text-[3.2vw] 3xl:text-[3vw]"
                    />
                  </div>
                )
              )}
  ...
  return (
    <Link href={href} target={target}>
      ...
      >
        ...
        >
          <div className="relative w-full h-[2px] xl:h-[3px] overflow-hidden">
