  ...
  return (
    <div className="flex flex-col w-full h-full pt-[2rem] pb-[4rem] lg:py-[2rem] 2xl:py-[4rem] relative overflow-hidden">
      <form
        ...
        className="grid grid-cols-4 lg:grid-cols-12 w-full h-full main-container pt-[3rem] lg:pt-[2.5rem] border-t gap-[2rem]"
      >
        ...
        <div className="col-span-4 lg:col-span-8">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-[1rem] lg:gap-[2rem]">
              ...
              <button type="submit" ref={BtnSubmit} className="w-full relative">
                <motion.div
                  initial="initial"
